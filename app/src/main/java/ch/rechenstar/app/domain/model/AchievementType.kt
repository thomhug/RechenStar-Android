...
enum class AchievementType(val rawValue: String) {
    ...
    val description: String
        get() = when (this) {
            EXERCISES_10 -> "Löse 10 Aufgaben"
            EXERCISES_50 -> "Löse 50 Aufgaben"
            EXERCISES_100 -> "Löse 100 Aufgaben"
            EXERCISES_500 -> "Löse 500 Aufgaben"
            STREAK_3 -> "Übe 3 Tage hintereinander"
            STREAK_7 -> "Übe 7 Tage hintereinander"
            STREAK_30 -> "Übe 30 Tage hintereinander"
            PERFECT_10 -> "10 perfekte Runden spielen"
            ALL_STARS -> "Sammle 100 Sterne"
            SPEED_DEMON -> "10 Aufgaben in 2 Minuten"
            EARLY_BIRD -> "Übe vor 8 Uhr morgens"
            NIGHT_OWL -> "Übe nach 20 Uhr abends"
            ...
            DAILY_CHAMPION -> "Löse 100 Aufgaben an einem Tag"
        }
